...
import { BarChart3, CalendarDays, Clapperboard, Home, Lightbulb, Palette, PlusCircle, type LucideIcon } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/calendar", label: "לוח תוכן", icon: CalendarDays },
